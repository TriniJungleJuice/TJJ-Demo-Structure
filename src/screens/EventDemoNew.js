                    ...
                    <Row>
                      <Col xs={10} md={10}>
                        ...
                        <Row style={{ color: '#9E9E9E' }}>
                          <Col xs={2} md={2} style={{ marginLeft: -10 }}><FontAwesomeIcon icon={faLocationDot} /> Miami, FL</Col>
                          <Col xs={6} md={6}><FontAwesomeIcon icon={faCalendar} /> Sunday January 14th, 2024 (12pm - 9pm)</Col>
                          <Col xs={4} md={4}><FontAwesomeIcon icon={faDollar} /> EC$240</Col>
                        </Row>
                        <br/>
                        <Row>
